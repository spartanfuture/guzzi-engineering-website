...
export default function Home() {
  return (
    <main className="min-h-screen bg-cover bg-center bg-fixed" style={{ backgroundImage: `url(${backgroundImage.src})` }}>
      <div className="container mx-auto px-8 py-16 bg-black bg-opacity-70">
        {/* First Row */}
        <section id="electric-future" className="mb-20 pt-24"> {/* Added id and increased pt-24 */}
          <h2 className={`text-4xl mb-12 text-center text-white ${ethnocentric.className}`}>Electric Future</h2>
          <div className="grid md:grid-cols-2 gap-12">
            {[
              { title: "Electric ATV's", image: image1, description: "Rugged, efficient Spartan Mini ATVs engineered for Northern Territory conditions. Experience the future of off-road mobility." },
              { title: "Vehicle Conversions", image: image2, description: "Transform your vehicle into a high-performance electric powerhouse. Custom solutions for sustainable, cutting-edge transportation." },
            ].map((tile, index) => (
        ...
        {/* Second Row */}
        <section id="services" className="mb-20 pt-24"> {/* Increased pt-24 */}
