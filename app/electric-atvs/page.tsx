...
export default function ElectricATVsPage() {
  ...
  const useCases = [
    {
      ...
      title: "Quiet Hunting",
      description:
        "Silent operation for undisturbed wildlife observation and hunting.",
      color: "text-green-400",
    },
    {
      icon: FaChild,
      title: "Family Fun",
      description: "Safe and convenient for all family adventures.",
      color: "text-blue-400",
    },
    {
      icon: FaMountain,
      title: "Exploring Adventure",
      description: "Go further with powerful efficient electric performance.",
  ...
  const specifications = [
    {
      icon: FaBolt,
      name: "Motor",
      value: "3000W Internal Permanent Magnet Motor",
      color: "text-yellow-400",
    },
    {
      icon: FaBatteryFull,
      name: "Battery",
      value: "72V 53Ah Lithium-ion",
  ...
  const NextArrow = ({ onClick }: { onClick?: () => void }) => (
    <button
      onClick={onClick}
      className="absolute right-4 top-1/2 transform -translate-y-1/2 z-10 bg-gray-800 bg-opacity-50 p-2 rounded-full"
    >
  ...
  const PrevArrow = ({ onClick }: { onClick?: () => void }) => (
    <button
      onClick={onClick}
      className="absolute left-4 top-1/2 transform -translate-y-1/2 z-10 bg-gray-800 bg-opacity-50 p-2 rounded-full"
    >
  ...
  return (
    <main
      className={`electric-atv-page min-h-screen bg-black text-white ${inter.className}`}
    >
      <div className="container mx-auto px-4 py-16 space-y-24">
        {/* Hero Section */}
        <section className="text-center mt-16">
          <h1
            className={`${ethnocentric.className} text-6xl mb-16 text-red-800`}
          >
            Spartan Mini ATV
          </h1>
          <div className="relative max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-center">
                <p className="text-3xl mb-2 text-white font-semibold italic">
        ...
        <section className="bg-gradient-to-b from-black to-black">
          <div className="container mx-auto px-4">
            <h2
              className={`${ethnocentric.className} text-4xl mb-12 text-center text-gray-400`}
            >
              ...
              {specifications.map((spec) => (
                ...
                >
                  <div className="text-center mb-4 flex flex-col items-center justify-center flex-grow">
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold mb-2 text-gray-200">
                      {spec.name}
                    </h3>
                  </div>
        ...
        <section className="max-w-6xl mx-auto px-4 ">
          <h2
            className={`${ethnocentric.className} text-4xl font-bold mb-16 text-center text-gray-400 tracking-wide`}
          >
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {useCases.map((useCase, index) => (
              ...
              >
                <div className="p-8">
                  <div
                    className={`flex items-center justify-center w-16 h-16 mb-6 rounded-full bg-gray-800 ${useCase.color}`}
                  >
                ...
                <div
                  className={`h-1 bg-gradient-to-r from-gray-800 via-${useCase.color.replace(
                    "text-",
                    ""
                  )} to-gray-800`}
                ></div>
